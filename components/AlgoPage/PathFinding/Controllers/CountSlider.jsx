...
import { setCellSize } from "@/redux/reducers/pathSlice";
...
const SizeController = () => {
  ...
  const maxCellSize = useSelector((state) => state.path.maxCellSize);
  const minCellSize = useSelector((state) => state.path.minCellSize);
  const cellSize = useSelector((state) => state.path.cellSize);
