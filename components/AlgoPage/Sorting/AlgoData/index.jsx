...
const AlgoData = () => {
  ...
  if (algoName) {
    ...
    if (currAlgoData) {
      return (
        <div>
          <div className="w-full h-[150px] bg-green-bg mt-gap font-space text-[1.5rem]
            lg:text-[2rem] text-text-1 flex items-center uppercase justify-center text-center">
            More About {algoName}
          </div>
          <div className="flex flex-col lg:grid lg:grid-cols-algoDataLayout gap-gap my-gap">
            ...
            <div className="w-full h-full font-space text-green flex flex-col gap-gap">
              ...
              <div className="border-[1px] border-border-1 px-[2rem] py-[1.5rem] flex flex-col gap-[2rem]">
                ...
                <div className="text-text-1 text-center uppercase">
                  {currAlgoData.stable}
                </div>
              </div>
            </div>
